    ...
    knownFset match {
      ...
      case "en-pos" =>        
        List(
          ...
          FeatureFn("trans1",wdFnNorm,true).over((-1 to 1)),
          FeatureFn(wdFnNorm).ngram((-1,0)),
          FeatureFn(wdFnNorm).ngram((0,1)),
          ...
          FeatureFn(wordPropertiesPrefixesFn(4,false)).ngram((-1 to 0)),
          FeatureFn(wordPropertiesPrefixesFn(6,false)).ngram((-1 to 0)),
          FeatureFn(wordPropertiesPrefixesFn(8,false)).ngram((-1 to 0)),          
          FeatureFn(wordPropertiesFn(false)).over((-2 to 2)),
          FeatureFn(wordPropertiesFn(false)).ngram((-1 to 0)),
